...
public class TestMainDay5 {
	...
	public static void main(String[] args) {
		...
		String sampleCodeInput = "3,21,1008,21,8,20,1005,20,22,107,8,21,20,1006,20,31,1106,0,36,98,0,0,1002,21,125,20,4,20,1105,1,46,104,999,1105,1,46,1101,1000,1,20,4,20,1105,1,46,98,99";
		String[] array = intCodeInput.split(",");
		// array[1] = "12";
		// array[2] = "2";

		int result = runIntCodeProgram(array);
	}
	...
	private static int runIntCodeProgram(String[] array) {
		...
		while (nextElem != 99 && count < 1000) {
			...
			case 4:
				el1 = retrieveValue(array, idxNextElement + 1, mode1);
				if (el1 != 0) {
					failure(array, idxNextElement, nextElem, count, "Check fails, DiagnostiCode=" + el1);
				} else {
