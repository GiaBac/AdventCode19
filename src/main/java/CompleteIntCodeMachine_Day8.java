...
public class CompleteIntCodeMachine_Day8 {
	...
	public CompleteIntCodeMachine_Day8(String[] array) {
	...
	public Result8 runIntCodeProgram(String phase, String input, boolean usePhase) {
		...
		while (op != 99) {
			...
			case 3:
				...
				writeValue(array, el1, (numInputInstr == 0 && usePhase) ? phase : input, mode1 == 2);
				numInputInstr++;
				idxNextElement += 2;
				break;
			case 4:
				...
				return new Result8(el1, false, idxNextElement + 2);
			case 5:
				el1 = retrieveValue(array, idxNextElement + 1, mode1);
				el2 = retrieveValue(array, idxNextElement + 2, mode2);
				if (el1 != 0) {
		...
		System.out.print("Array[idxNextElement]= " + readArrayValue(array, idxNextElement));
...
class Result8 {
	...
	public Result8(double res, boolean isStop, double idNextInstr) {
		this.res = res;
		this.isStop = isStop;
