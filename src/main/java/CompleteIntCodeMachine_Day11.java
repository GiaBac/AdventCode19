...
public class CompleteIntCodeMachine_Day11 {
	...
	public CompleteIntCodeMachine_Day11(String[] array, InputProvider inputProvider) {
	...
	public Result11 runIntCodeProgram() {
